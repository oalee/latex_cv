...
\section{Experience}
    ...
    \explanationdetail{Persian Sign Language Learning Assistant Native Android Application for children with the use of Visual Learning techniques by providing videos and images. New learning modules could be added to the existing app from a node js server.     }
